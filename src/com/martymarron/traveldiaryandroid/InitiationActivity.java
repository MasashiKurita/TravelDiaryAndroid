...
public class InitiationActivity extends ActionBarActivity {
...
//			arguments.putString(SaveDataDetailFragment.ARG_ITEM_ID, getIntent()
//					.getStringExtra(SaveDataDetailFragment.ARG_ITEM_ID));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == android.R.id.home) {
			...
			NavUtils.navigateUpTo(this, new Intent(this,
					SaveDataListActivity.class));
			return true;
		}
		return super.onOptionsItemSelected(item);
	}
	
	public void openCreateStory(View view) {
