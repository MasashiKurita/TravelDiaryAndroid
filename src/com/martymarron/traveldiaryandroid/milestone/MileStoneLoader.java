...
//                GraphRequest request = GraphRequest.newGraphPathRequest(accessToken, new ReadRequestCallback(callback));
//                GraphRequestAsyncTask asyncTask = new GraphRequestAsyncTask(request);
//                asyncTask.execute();
//		    }
//		} catch (Exception e) {
...
//		}
	...
	private abstract class MileStoneRequestCallback implements GraphRequest.Callback {
